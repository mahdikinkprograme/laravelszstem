      ...
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "{{asset('admin/img/'.$product->image)}}" alt = "shoe image">
          ...
          <div class = "img-select">
            <div class = "img-item">
              <a href = "#" data-id = "1">
                <img src = "{{asset('admin/img/home.png')}}" alt = "shoe image">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "2">
       ...
       <div class="alert alert-warning alert-dismissible fade show" role="alert">{{session('succes')}}
        ...
        @endif
          ...
          <form action= "{{ url('carts/'.$product->id) }}" method="GET">@csrf
          <div class = "purchase-info">
            <input type = "number" min = "0" value = "1" name="prod_qty" class="quantity">
            <button><a class="button home__button">add to cart</a></button>
